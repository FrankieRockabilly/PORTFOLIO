                     ...
                     >
                        {testimonial.map((value, index) => (
                           <SwiperSlide key={index} className="flex justify-center">
                              <div className="bg-white rounded-lg px-4 md:px-12 py-5 border shadow-inner w-[22rem] md:w-[26rem] h-60 overflow-hidden flex flex-col justify-start items-start gap-2">
