        ...
        <>
            <div className='lg:px-36 pt-20 px-5 '>
                ...
                <div className='flex flex-wrap justify-center items-start gap-14 py-20'>
                    <div className='w-[28rem] h-[25rem] lg:w-[35rem] lg:h-[30rem] aboutbox '>
                        <img src="https://varthana.com/student/wp-content/uploads/2023/09/B557-Student.jpg" alt="" className='rounded-xl w-full h-full object-cover' />
                    </div>
                        ...
                        <div className='flex justify-start items-center gap-5'>
                            ...
                            <div className='my-4'>
                                <a href="/RESUME.pdf" download="RESUME.pdf">
                                    <button className="bg-gradient-to-r from-red-600 to-gray-700 text-white px-5 py-3 rounded">Download My CV</button>
                                </a>
                            </div>
