         ...
         <div className="lg:px-36 pt-20 px-5 ">
            ...
            <div className="flex flex-wrap justify-center items-center gap-14 py-5 ">
               ...
               <div className="flex flex-col justify-start items-start gap-8  max-w-[55rem]  ">
                  <h1 className="font-semibold text-center lg:text-start text-4xl xl:text-6xl text-oren -tracking-tight w-full head">
                     Meet the <span className='text-primary'>Developer</span>
                  </h1>
                  <p className="text-lg indent-16 text-gray-500 text-justify aboutbox2">
                  ...
                  <div className="flex justify-start items-center gap-7 w-full lg:gap-10 paragraph text-gray-500 ">
                     ...
                     <div className='flex flex-wrap justify-start items-center gap-2 max-w-[35rem]'>
                        <div className='w-20 h-20 lg:w-24 lg:h-24 bg-orange-600 shadow-xl shadow-orange-400 rounded-xl flex justify-center items-center gap-2 text-white aboutbox'>
                           <SiHtml5 size={30}/>
                        </div>
                        <div className='w-20 h-20 lg:w-24 lg:h-24 bg-blue-600 shadow-xl shadow-blue-400 rounded-xl flex justify-center items-center gap-2 text-white aboutbox'>
                           <FaCss3 size={30}/>
                        </div>
                        <div className='w-20 h-20 lg:w-24 lg:h-24 bg-yellow-600 shadow-xl shadow-yellow-400 rounded-xl flex justify-center items-center gap-2 text-white aboutbox'>
                           <RiJavascriptFill size={30}/>
                        </div>
                        <div className='w-20 h-20 lg:w-24 lg:h-24 bg-cyan-600 shadow-xl shadow-cyan-400 rounded-xl flex justify-center items-center gap-2 text-white aboutbox'>
                           <FaReact size={30}/>
                        </div>
                        <div className='w-20 h-20 lg:w-24 lg:h-24 bg-green-600 shadow-xl shadow-green-400 rounded-xl flex justify-center items-center gap-2 text-white aboutbox'>
                           <FaNodeJs size={30}/>
                        </div>
                        <div className='w-20 h-20 lg:w-24 lg:h-24 bg-blue-400 shadow-xl shadow-purple-200 rounded-xl flex justify-center items-center gap-2 text-white aboutbox'>
                           <SiTailwindcss size={30}/>
                        </div>
                        <div className='w-20 h-20 lg:w-24 lg:h-24 bg-purple-400 shadow-xl shadow-purple-200 rounded-xl flex justify-center items-center gap-2 text-white aboutbox'>
                           <SiMysql size={50}/>
                        </div>
                        <div className='w-20 h-20 lg:w-24 lg:h-24 bg-gray-600 shadow-xl shadow-gray-400 rounded-xl flex justify-center items-center gap-2 text-white aboutbox'>
                           <SiExpress size={30}/>
                        </div>
                     </div>
                     <div className="">
